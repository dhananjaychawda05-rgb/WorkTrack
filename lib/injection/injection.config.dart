...
import '../features/auth/presentation/bloc/register_bloc.dart' as _i222;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i59.AuthBloc>(() => _i59.AuthBloc(gh<_i471.LocalStorage>()));
    gh.factory<_i980.SplashCubit>(
      () => _i980.SplashCubit(gh<_i471.LocalStorage>()),
    );
    gh.lazySingleton<_i393.DioClient>(
      () => _i393.DioClient(gh<_i471.LocalStorage>()),
    );
    gh.factory<_i130.AuthRemoteDataSource>(
      () => _i130.AuthRemoteDataSourceImpl(gh<_i393.DioClient>()),
    );
    ...
    gh.factory<_i754.SignupUseCase>(
      () => _i754.SignupUseCase(gh<_i869.AuthRepository>()),
    );
    gh.factory<_i222.RegisterBloc>(
      () => _i222.RegisterBloc(gh<_i754.SignupUseCase>()),
    );
    gh.factory<_i724.LoginBloc>(
      () => _i724.LoginBloc(gh<_i406.LoginUseCase>()),
    );
    return this;
  }
}
